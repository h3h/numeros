export class Numero {
  ...
  #nouns = [
    ...
    { noun: 'gatos', gender: 'm', emoji: '🐱' },
    { noun: 'peces', gender: 'm', emoji: '🐟' },
    { noun: 'cerdos', gender: 'm', emoji: '🐷' },
    { noun: 'ratones', gender: 'm', emoji: '🐭' },
    { noun: 'plátanos', gender: 'm', emoji: '🍌' },
    { noun: 'árboles', gender: 'm', emoji: '🌳' },
    { noun: 'soles', gender: 'm', emoji: '☀️' },
    { noun: 'libros', gender: 'm', emoji: '📚' },
    { noun: 'globos', gender: 'm', emoji: '🎈' },
    { noun: 'regalos', gender: 'm', emoji: '🎁' },
    { noun: 'fresas', gender: 'f', emoji: '🍓' },
    { noun: 'uvas', gender: 'f', emoji: '🍇' },
    { noun: 'zanahorias', gender: 'f', emoji: '🥕' },
    { noun: 'tortugas', gender: 'f', emoji: '🐢' },
    { noun: 'abejas', gender: 'f', emoji: '🐝' },
    { noun: 'mariposas', gender: 'f', emoji: '🦋' },
    { noun: 'vacas', gender: 'f', emoji: '🐄' },
    { noun: 'gallinas', gender: 'f', emoji: '🐔' },
    { noun: 'flores', gender: 'f', emoji: '🌸' },
    { noun: 'estrellas', gender: 'f', emoji: '⭐' },
  ]
